...
const CartPage = () => {
  ...
  const { cart, totalAmount, isLoading, error, removeItem } = useCart();
        ...
        <div className="grid grid-cols-1 gap-4">
          {[1, 2].map((i) => (
            <Card key={i} className="w-full mb-4">
              <CardContent>
                <div className="text-center">
                  <div className="bg-accent animate-pulse h-24 w-24 rounded-md mb-4 mx-auto"></div>
                  <div className="bg-accent animate-pulse h-6 w-3/4 mb-2 mx-auto rounded-md"></div>
                  <div className="bg-accent animate-pulse h-4 w-1/2 mb-2 mx-auto rounded-md"></div>
                </div>
              </CardContent>
            </Card>
          ))}
          <Card className="w-full">
            <CardContent>
              <div className="text-center">
                <div className="bg-accent animate-pulse h-6 w-full mb-4 rounded-md"></div>
          ...
          <Card className="w-full">
            <CardContent>
              <div className="text-center">
                ...
                <Button onClick={handleContinueShopping} className="mt-2">
                  Continue Shopping
                </Button>
              </div>
            </CardContent>
      ...
      <div className="grid grid-cols-1 gap-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2">
            {cart.map((item) => (
              <Card key={item._id} className="w-full mb-4">
                <CardContent>
