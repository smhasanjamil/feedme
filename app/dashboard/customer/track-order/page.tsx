            ...
            <Tabs defaultValue="tracking" className="w-full">
              ...
              <TabsContent value="tracking">
                  ...
                  <div className="flex justify-between relative mb-8">
                    ...
                    {orderStatusSteps.map((step, index) => {
                      ...
                      const isCompleted = orderData.trackingStages 
                        ? orderData.trackingStages[step.id as keyof typeof orderData.trackingStages]
                      ...
                      const isActive = orderData.trackingStages
                        ? (orderData.trackingStages[step.id as keyof typeof orderData.trackingStages] && 
                           (index === 0 || !orderData.trackingStages[orderStatusSteps[index+1]?.id as keyof typeof orderData.trackingStages]))
                ...
                <div className="border rounded-lg p-4 bg-blue-50 mb-4">
                  <div className="flex items-start mb-2">
                    ...
                    <div>
                      <h3 className="font-medium text-blue-800">Estimated Delivery Date</h3>
                      <p className="text-blue-700">Your order is expected to be delivered on:</p>
                      <p className="font-bold text-blue-900">{formatDate(orderData.deliveryDate)}</p>
                      <p className="text-blue-700">Delivery Slot: {orderData.deliverySlot}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="border rounded-lg p-4">
                    ...
                    <p className="text-gray-600">{orderData.currentLocation || orderData.city || "Processing"}</p>
                    <p className="text-gray-500 text-sm">{orderData.facility || "Processing facility"}</p>
                  </div>
                  ...
                  <div className="border rounded-lg p-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div>
                        <p className="text-sm text-gray-500">Order last updated</p>
                        <p className="font-medium">{formatDate(orderData.updatedAt)}</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <TabsContent value="details">
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-gray-600">Tracking Number: {orderData.trackingNumber}</p>
                  <p className="text-gray-600">Current Status: {orderData.status}</p>
                  <p className="text-gray-600">Estimated Delivery: {formatDate(orderData.deliveryDate)}</p>
                  <p className="text-gray-600">Delivery Slot: {orderData.deliverySlot}</p>
              ...
              <TabsContent value="shipping">
                <div className="space-y-6">
                  ...
                  <div className="border rounded-lg p-4">
                    ...
                    <p className="text-gray-600">{orderData.city}, {orderData.zipCode}</p>
                  </div>
                  ...
                  <div className="border rounded-lg p-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-[120px_1fr] gap-2">
                        ...
                        <p className="text-gray-800">{orderData.deliverySlot}</p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="border rounded-lg p-4">
                      ...
                      <div className="space-y-2">
                        <div className="grid grid-cols-[120px_1fr] gap-2">
                          ...
                          <p className="text-gray-800">{orderData.transaction.id}</p>
                        </div>
                        <div className="grid grid-cols-[120px_1fr] gap-2">
                          <p className="text-gray-500">Status:</p>
                          <p className="text-gray-800">{orderData.transaction.transactionStatus}</p>
                        </div>
                        <div className="grid grid-cols-[120px_1fr] gap-2">
