      ...
      {completedOrders.length > 0 ? (
          ...
          {completedOrders.map((order) => (
            <Card key={order._id} className="overflow-hidden">
              ...
              <CardContent className="p-0">
                <div className="p-4">
                  <h3 className="mb-2 text-sm font-medium">Rate Your Meals</h3>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center p-6">
            <Star className="mb-2 h-10 w-10 text-gray-300" />
            <h3 className="text-sm font-medium">No completed orders found</h3>
            <p className="mt-1 text-center text-xs text-gray-500">
              Your completed orders will appear here for rating once they are
              delivered.
            </p>
          </CardContent>
        </Card>
